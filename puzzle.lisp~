...
(defun peca-contagem (tabuleiro tipo-peca &optional (linha 13) (coluna 13))
  ...
  (cond
   ((and (zerop linha) (zerop coluna)) ;Se tivermos na posicao 0,0
    (cond
     ((eq (nth 0 (nth 0 tabuleiro)) 1) (tipo-pecap linha coluna tabuleiro tipo-peca)) ;Se existir um 1 na posicao 0,0 vamos ver qual e o tipo dessa peca
     (T 0)
    )
   )
   
   ((= coluna -1) (peca-contagem tabuleiro tipo-peca (1- linha) 13 )) ;;Quando a coluna e igual a -1 vamos para a linha de cima e voltamos a coluna 13
  ...
  (cond
   ...
   ((and (zerop linha) (zerop coluna))
    (cond
     ...
     )  ;Caso seja uma peca pequena e na posicao 0,0 esteja um zero entao e uma jogada possivel, passamos a verificar a posicao 0,13

     ((and (not (casa-com-ump 0 0 tabuleiro)) (zerop (nth 0 (nth 0 tabuleiro))) (equal tipo-peca 'media) (pode-colocarp 0 0 tabuleiro 'media) )
      (append '((0 0)) (jogada-inicial-p tabuleiro tipo-peca 0 13))
      ) ;Caso seja uma peca media e na posicao 0,0 esteja um zero entao e uma jogada possivel, passamos a verificar a posicao 0,13

     (T (jogada-inicial-p tabuleiro tipo-peca 0 13))  ;Passamos a verificar a posicao 0,13
    )
   )
   ...
   ((and (zerop linha) (= coluna 13))
    (cond
     ((and (not (casa-com-ump 0 13 tabuleiro)) (zerop (nth 13 (nth 0 tabuleiro))) (equal tipo-peca 'pequena))
      ...
      ) ;Caso seja uma peca pequena e na posicao 0,13 esteja um zero entao e uma jogada possivel, passamos a verificar a posicao 13,0
     ...
     )  ;Caso seja uma peca media e na posicao 0,13 esteja um zero entao e uma jogada possivel, passamos a verificar a posicao 13,0

     (T (jogada-inicial-p tabuleiro tipo-peca 13 0))  ;Passamos a verificar a posicao 13,0
     )
    )
   ...
   ((and (= linha 13) (zerop coluna))
    (cond
     ...
     ) ;Caso seja uma peca pequena e na posicao 13,0 esteja um zero entao e uma jogada possivel, passamos a verificar a posicao 13,13
     ...
     )  ;Caso seja uma peca media e na posicao 13,0 esteja um zero entao e uma jogada possivel, passamos a verificar a posicao 13,13

     (T (jogada-inicial-p tabuleiro tipo-peca 13 13)) ;passmos a verificar a posicao 13,13
     )
    )
...
(defun percorre-matriz-peca (tabuleiro tipo-peca &optional (linha 13) (coluna 13))
  ...
  (cond
   ...
   ((= coluna -1) (percorre-matriz-peca tabuleiro tipo-peca (1- linha) 13)) ;Quando estivermos na coluna -1, vamos para a linha de cima e voltamos a coluna 13
