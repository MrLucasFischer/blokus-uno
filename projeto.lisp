...
(defun escrever-resultados (resultado)
  ...
  (let (
        (tabuleiro (first resultado))
        (pecas (second resultado))
        (profundidade (third resultado))
        (heuristica-resultado (fourth resultado))
        (custo-resultado (fifth resultado))
        (no-pai-resultado (sixth resultado))
       )
    (progn
